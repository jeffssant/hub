...
function phpMail($user, $telefone, $email, $local){
	...
	destinatário');
	//Destinatários
	$mailer->Subject = 'Novo usuario cadastrado - '.$local;
	$mailer->Body = 'Olá Houve um novo cadastro através do formulario ' .$local.'.<br><strong>Seguem os dados para contato</strong> <br> Nome:'.$user.'<br> Telefone:'.$telefone.'<br> E-mail: '.$email.'<br><br> Mais informações poderam ser acessadas via painel administrativo';
	$mailer->IsHTML(true); 
	if(!$mailer->Send())
	{
